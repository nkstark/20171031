...
HD_PWD='C:/Users/nks/Desktop/test_725/project_1/project_1.runs/SUB_CLK_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SUB_CLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SUB_CLK.tcl
