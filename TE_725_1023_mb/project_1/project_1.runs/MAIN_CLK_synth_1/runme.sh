...
HD_PWD='C:/Users/nks/Desktop/TE_725_1023/project_1/project_1.runs/MAIN_CLK_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAIN_CLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAIN_CLK.tcl
